...
(function (raiz) {
  ...
  var TEXTOS = {
    ...
    alqmax: {
      ...
      v_horquilla:  { es: 'entre {min} y {max}/mes' },
      l_ing_uno:    { es: 'Tus ingresos (pagas prorrateadas)' },
      l_ing_var:    { es: 'Ingresos conjuntos (pagas prorrateadas)' },
      av_nose:      { es: 'no lo sé' },
      doc_uno:      { es: 'Documentación: ✓ Tus ingresos — ya me los has dicho / ○ 3 últimas nóminas (o renta/modelos trimestrales si eres autónomo; certificado de pensión si eres pensionista) / ○ Tu DNI / ○ Datos del avalista si lo usas' },
      doc_var:      { es: 'Documentación: ✓ Vuestros ingresos — ya me los habéis dicho / ○ 3 últimas nóminas (o renta/modelos trimestrales si sois autónomos; certificado de pensión si sois pensionistas) / ○ DNI de los titulares / ○ Datos del avalista si lo usáis' },
